  ...
  try {
    ...
    const html = `
      ...
      <body>
        ...
        <script src="/scripts/sanitizeText.js?v=1767120429"></script>
        <script src="/scripts/splat.js?v=1767120429"></script>
        <script src="/scripts/comments.js?v=1767120429"></script>
        <script src="/scripts/read.js?v=1767120429"></script>
      </body>
      </html>
    `;
